#include "ThermalExpansionShockHeatSourceFiniteStrainMieGruneisenConstHNoCpl.h"

registerMooseObject("pandaApp",ThermalExpansionShockHeatSourceFiniteStrainMieGruneisenConstHNoCpl);

template <>
InputParameters
validParams<ThermalExpansionShockHeatSourceFiniteStrainMieGruneisenConstHNoCpl>()
{
...
ThermalExpansionShockHeatSourceFiniteStrainMieGruneisenConstHNoCpl::ThermalExpansionShockHeatSourceFiniteStrainMieGruneisenConstHNoCpl(const InputParameters & parameters)
...
Real
ThermalExpansionShockHeatSourceFiniteStrainMieGruneisenConstHNoCpl::computeQpResidual()
{
  Real heat_source, Je;
...
Real
ThermalExpansionShockHeatSourceFiniteStrainMieGruneisenConstHNoCpl::computeQpJacobian()
{
  Real Kb = _Bulk_Modulus_Ref;
...
Real
ThermalExpansionShockHeatSourceFiniteStrainMieGruneisenConstHNoCpl::computeQpOffDiagJacobian(unsigned int jvar)
{
  Real val;
  Real Kb = _Bulk_Modulus_Ref;
  RankTwoTensor ce, ce_old, iden, ee, ee_old, ee_rate;
