#include "ThermalExpansionHeatSourceFiniteStrainMieGruneisen_old.h"

registerMooseObject("pandaApp",ThermalExpansionHeatSourceFiniteStrainMieGruneisen_old);


template <>
InputParameters
validParams<ThermalExpansionHeatSourceFiniteStrainMieGruneisen_old>()
{
...
ThermalExpansionHeatSourceFiniteStrainMieGruneisen_old::ThermalExpansionHeatSourceFiniteStrainMieGruneisen_old(const InputParameters & parameters)
...
Real
ThermalExpansionHeatSourceFiniteStrainMieGruneisen_old::computeQpResidual()
{
  Real heat_source, Je;
...
Real
ThermalExpansionHeatSourceFiniteStrainMieGruneisen_old::computeQpJacobian()
{
  Real Kb = _Bulk_Modulus_Ref;
...
Real
ThermalExpansionHeatSourceFiniteStrainMieGruneisen_old::computeQpOffDiagJacobian(unsigned int jvar)
{
  Real val;
  Real Kb = _Bulk_Modulus_Ref;
  RankTwoTensor ce, ce_old, iden, ee, ee_old, ee_rate;
