...
#include "BarrierFunctionMaterialNew.h"

registerMooseObject("pandaApp", BarrierFunctionMaterialNew);

template <>
InputParameters
validParams<BarrierFunctionMaterialNew>()
{
...
BarrierFunctionMaterialNew::BarrierFunctionMaterialNew(const InputParameters & parameters)
...
void
BarrierFunctionMaterialNew::computeQpProperties()
{
