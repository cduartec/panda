#include "FiniteStrainCPPFFractureMieGruneisenConstHVol.h"
...
registerMooseObject("pandaApp", FiniteStrainCPPFFractureMieGruneisenConstHVol);

template<>
InputParameters validParams<FiniteStrainCPPFFractureMieGruneisenConstHVol>()
{
...
FiniteStrainCPPFFractureMieGruneisenConstHVol::FiniteStrainCPPFFractureMieGruneisenConstHVol(const InputParameters & parameters) :
...
void
FiniteStrainCPPFFractureMieGruneisenConstHVol::initQpStatefulProperties()
{
  _stress[_qp].zero();
...
void
FiniteStrainCPPFFractureMieGruneisenConstHVol::preSolveStatevar()
{
...
void
FiniteStrainCPPFFractureMieGruneisenConstHVol::solveStatevar()
{
  Real gmax, gdiff;
  unsigned int iterg;
  ...
  {
#ifdef DEBUG
    mooseWarning("FiniteStrainCPPFFractureMieGruneisenConstHVol: Hardness Integration error gmax", gmax, "\n");
#endif
    _err_tol = true;
  }
}
...
void
FiniteStrainCPPFFractureMieGruneisenConstHVol::postSolveStatevar()
{
  if (_max_substep_iter == 1)//No substepping
  {
    _gss[_qp] = _gss_tmp;
 ...
 */
void
FiniteStrainCPPFFractureMieGruneisenConstHVol::updateGss()
{
...
void
FiniteStrainCPPFFractureMieGruneisenConstHVol::update_energies()
{
...
void
FiniteStrainCPPFFractureMieGruneisenConstHVol::calcResidual( RankTwoTensor &resid )
{
  ...
  } else {// In compression use energy from  EOS
...
void
FiniteStrainCPPFFractureMieGruneisenConstHVol::getSlipIncrements()
{
 // Real Je;
