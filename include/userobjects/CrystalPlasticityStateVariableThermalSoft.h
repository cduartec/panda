...
#ifndef CRYSTALPLASTICITYSTATEVARIABLETHERMALSOFT_H
#define CRYSTALPLASTICITYSTATEVARIABLETHERMALSOFT_H

#include "CrystalPlasticityUOBase.h"

class CrystalPlasticityStateVariableThermalSoft;

template <>
InputParameters validParams<CrystalPlasticityStateVariableThermalSoft>();

/**
 * Crystal plasticity state variable userobject class.
 */
class CrystalPlasticityStateVariableThermalSoft : public CrystalPlasticityUOBase
{
public:
  CrystalPlasticityStateVariableThermalSoft(const InputParameters & parameters);
...
#endif // CRYSTALPLASTICITYSTATEVARIABLETHERMALSOFT_H
