#ifndef THERMALEXPANSIONHEATSOURCEFINITESTRAINMIEGRUNEISEN_OLD_H
#define THERMALEXPANSIONHEATSOURCEFINITESTRAINMIEGRUNEISEN_OLD_H
...
class ThermalExpansionHeatSourceFiniteStrainMieGruneisen_old;

template <>
InputParameters validParams<ThermalExpansionHeatSourceFiniteStrainMieGruneisen_old>();
 ...
 */
class ThermalExpansionHeatSourceFiniteStrainMieGruneisen_old : public HeatSource
{
public:
  ThermalExpansionHeatSourceFiniteStrainMieGruneisen_old(const InputParameters & parameters);
...
#endif // THERMALEXPANSIONHEATSOURCEFINITESTRAINMIEGRUNEISEN_OLD_H
