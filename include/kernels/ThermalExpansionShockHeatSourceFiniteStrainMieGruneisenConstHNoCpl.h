#ifndef THERMALEXPANSIONSHOCKHEATSOURCEFINITESTRAINMIEGRUNEISENCONSTHNOCPL_H
#define THERMALEXPANSIONSHOCKHEATSOURCEFINITESTRAINMIEGRUNEISENCONSTHNOCPL_H
...
class ThermalExpansionShockHeatSourceFiniteStrainMieGruneisenConstHNoCpl;

template <>
InputParameters validParams<ThermalExpansionShockHeatSourceFiniteStrainMieGruneisenConstHNoCpl>();
 ...
 */
class ThermalExpansionShockHeatSourceFiniteStrainMieGruneisenConstHNoCpl : public HeatSource
{
public:
  ThermalExpansionShockHeatSourceFiniteStrainMieGruneisenConstHNoCpl(const InputParameters & parameters);
...
#endif // THERMALEXPANSIONSHOCKHEATSOURCEFINITESTRAINMIEGRUNEISENCONSTHNOCPL_H
