#ifndef THERMALEXPANSIONHEATSOURCEFINITESTRAINMIEGRUNEISENNEWCONST_H
#define THERMALEXPANSIONHEATSOURCEFINITESTRAINMIEGRUNEISENNEWCONST_H
...
class ThermalExpansionHeatSourceFiniteStrainMieGruneisenConst;

template <>
InputParameters validParams<ThermalExpansionHeatSourceFiniteStrainMieGruneisenConst>();
 ...
 */
class ThermalExpansionHeatSourceFiniteStrainMieGruneisenConst : public HeatSource
{
public:
  ThermalExpansionHeatSourceFiniteStrainMieGruneisenConst(const InputParameters & parameters);
...
#endif // THERMALEXPANSIONHEATSOURCEFINITESTRAINMIEGRUNEISENNEWCONST_H
