...
#ifndef FINITESTRAINCRYSTALPLASTICITYSOFT_H
#define FINITESTRAINCRYSTALPLASTICITYSOFT_H

#include "ComputeStressBase.h"

class FiniteStrainCrystalPlasticitySoft;

template <>
InputParameters validParams<FiniteStrainCrystalPlasticitySoft>();
 ...
 */
class FiniteStrainCrystalPlasticitySoft : public ComputeStressBase
{
public:
  FiniteStrainCrystalPlasticitySoft(const InputParameters & parameters);
...
#endif // FINITESTRAINCRYSTALPLASTICITYSOFT_H
