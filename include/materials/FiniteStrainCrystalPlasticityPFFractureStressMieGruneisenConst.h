...
/****************************************************************/
#ifndef FINITESTRAINCRYSTALPLASTICITYPFFRACTURESTRESSMIEGRUNEISENCONST_H
#define FINITESTRAINCRYSTALPLASTICITYPFFRACTURESTRESSMIEGRUNEISENCONST_H

#include "FiniteStrainCrystalPlasticity.h"

/**
 * FiniteStrainCrystalPlasticityPFFractureStressMieGruneisenConst uses the multiplicative decomposition of deformation gradient
 ...
 */
class FiniteStrainCrystalPlasticityPFFractureStressMieGruneisenConst;

template<>
InputParameters validParams<FiniteStrainCrystalPlasticityPFFractureStressMieGruneisenConst>();

class FiniteStrainCrystalPlasticityPFFractureStressMieGruneisenConst : public FiniteStrainCrystalPlasticity
{
public:
  FiniteStrainCrystalPlasticityPFFractureStressMieGruneisenConst(const InputParameters & parameters);
...
protected:
  ...
  MaterialProperty<Real> &  _heat_rate_vis;
  MaterialProperty<Real> &  _heat_rate_therm;
