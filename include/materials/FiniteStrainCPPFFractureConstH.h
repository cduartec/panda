...
/****************************************************************/
#ifndef FINITESTRAINCPPFFRACTURECONSTH_H
#define FINITESTRAINCPPFFRACTURECONSTH_H

#include "FiniteStrainCrystalPlasticity.h"

/**
 * FiniteStrainCPPFFractureConstH uses the multiplicative decomposition of deformation gradient
 ...
 */
class FiniteStrainCPPFFractureConstH;

template<>
InputParameters validParams<FiniteStrainCPPFFractureConstH>();

class FiniteStrainCPPFFractureConstH : public FiniteStrainCrystalPlasticity
{
public:
  FiniteStrainCPPFFractureConstH(const InputParameters & parameters);
...
#endif //FINITESTRAINCRYSTALPLASTICITYPFFRACTURESTRESSCONST_H
