...
/****************************************************************/
#ifndef FINITESTRAINCRYSTALPLASTICITYPFFRACTURESTRESSMIEGRUNEISENNEWINITDAMVOL_H
#define FINITESTRAINCRYSTALPLASTICITYPFFRACTURESTRESSMIEGRUNEISENNEWINITDAMVOL_H
 ...
 */
class FiniteStrainCrystalPlasticityPFFractureStressMieGruneisenNewInitDamVol;

template<>
InputParameters validParams<FiniteStrainCrystalPlasticityPFFractureStressMieGruneisenNewInitDamVol>();

class FiniteStrainCrystalPlasticityPFFractureStressMieGruneisenNewInitDamVol : public FiniteStrainCrystalPlasticity
{
public:
  FiniteStrainCrystalPlasticityPFFractureStressMieGruneisenNewInitDamVol(const InputParameters & parameters);
...
#endif //FINITESTRAINCRYSTALPLASTICITYPFFRACTURESTRESSMIEGRUNEISENNEWINITDAMVOL_H
