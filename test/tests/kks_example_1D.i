...
[Functions]
  ...
  [./ic_func_c]
    type = ParsedFunction
    #value = 0.5
    value = '0.8*(0.5*(1.0-tanh((x+20)/sqrt(2.0))))^3*(6*(0.5*(1.0-tanh((x+20)/sqrt(2.0))))^2-15*(0.5*(1.0-tanh((x+20)/sqrt(2.0))))+10)+0.2*(1-(0.5*(1.0-tanh((x+20)/sqrt(2.0))))^3*(6*(0.5*(1.0-tanh((x+20)/sqrt(2.0))))^2-15*(0.5*(1.0-tanh((x+20)/sqrt(2.0))))+10))'
  [../]
[]
